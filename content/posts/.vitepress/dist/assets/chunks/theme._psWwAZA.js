const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/VPLocalSearchBox.d6-Oxndv.js","assets/chunks/framework.BiMWp1ZL.js"])))=>i.map(i=>d[i]);
import { d as defineComponent, c as createElementBlock, r as renderSlot, n as normalizeClass, o as openBlock, a as createTextVNode, t as toDisplayString, b as createBlock, w as withCtx, T as Transition, e as createCommentVNode, _ as _export_sfc, u as useData$1, i as isExternal, f as treatAsHtml, g as withBase, h as computed, j as createBaseVNode, k as unref, l as isActive, m as useMediaQuery, p as ref, q as watch, s as watchEffect, v as onMounted, x as onUnmounted, y as watchPostEffect, z as onUpdated, A as getScrollOffset, F as Fragment, B as renderList, C as resolveComponent, D as onContentUpdated, E as createVNode, G as shallowRef, H as resolveDynamicComponent, I as EXTERNAL_URL_RE, J as useRoute, K as mergeProps, L as inject, M as useWindowSize, N as normalizeStyle, O as onKeyStroke, P as nextTick, Q as useWindowScroll, R as inBrowser, S as readonly, U as defineAsyncComponent, V as __vitePreload, W as useScrollLock, X as provide, Y as toHandlers, Z as withKeys, $ as onBeforeUnmount, a0 as withModifiers, a1 as useSlots, a2 as createStaticVNode } from "./framework.BiMWp1ZL.js";
...
const _sfc_main$n = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const VPLocalSearchBox = defineAsyncComponent(() => __vitePreload(() => import("./VPLocalSearchBox.d6-Oxndv.js"), true ? __vite__mapDeps([0,1]) : void 0));
...
const _hoisted_1$3 = { class: "svg-icon" };
const _hoisted_2$2 = {
  key: 0,
  class: "icon-blog",
  viewBox: "0 0 24 24",
  ...
  setup(__props) {
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$3, [
        __props.name === "blog" ? (openBlock(), createElementBlock("svg", _hoisted_2$2, [..._cache[0] || (_cache[0] = [
          createStaticVNode('<rect x="3" y="4" width="18" height="18" rx="2" ry="2" data-v-f1dff19b></rect><line x1="16" y1="2" x2="16" y2="6" data-v-f1dff19b></line><line x1="8" y1="2" x2="8" y2="6" data-v-f1dff19b></line><line x1="3" y1="10" x2="21" y2="10" data-v-f1dff19b></line><path d="M8 14h.01" data-v-f1dff19b></path><path d="M12 14h.01" data-v-f1dff19b></path><path d="M16 14h.01" data-v-f1dff19b></path><path d="M8 18h.01" data-v-f1dff19b></path><path d="M12 18h.01" data-v-f1dff19b></path><path d="M16 18h.01" data-v-f1dff19b></path><path d="M19 9l-5 5-4-4-3 3" data-v-f1dff19b></path>', 11)
        ])])) : __props.name === "link" ? (openBlock(), createElementBlock("svg", _hoisted_3$1, [..._cache[1] || (_cache[1] = [
          createBaseVNode("path", { d: "M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71" }, null, -1),
          createBaseVNode("path", { d: "M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71" }, null, -1)
        ])])) : __props.name === "idea" ? (openBlock(), createElementBlock("svg", _hoisted_4$1, [..._cache[2] || (_cache[2] = [
          createBaseVNode("path", { d: "M12 2a6 6 0 0 0-6 6c0 7 6 12 6 12s6-5 6-12a6 6 0 0 0-6-6z" }, null, -1),
          createBaseVNode("circle", {
            cx: "12",
            cy: "10",
            r: "3"
          }, null, -1)
        ])])) : __props.name === "glass" ? (openBlock(), createElementBlock("svg", _hoisted_5$1, [..._cache[3] || (_cache[3] = [
          createBaseVNode("path", { d: "M2 3h20" }, null, -1),
          createBaseVNode("path", { d: "M5 3v18c0 1.1.9 2 2 2h10c1.1 0 2-.9 2-2V3" }, null, -1),
          createBaseVNode("path", { d: "M12 18v4" }, null, -1),
          createBaseVNode("path", { d: "M9 22h6" }, null, -1)
        ])])) : __props.name === "search" ? (openBlock(), createElementBlock("svg", _hoisted_6$1, [..._cache[4] || (_cache[4] = [
          createBaseVNode("circle", {
            cx: "11",
            cy: "11",
            r: "8"
        ...
        ])])) : __props.name === "responsive" ? (openBlock(), createElementBlock("svg", _hoisted_7, [..._cache[5] || (_cache[5] = [
        ...
        ])])) : (openBlock(), createElementBlock("span", _hoisted_8, toDisplayString(__props.name), 1))
      ]);
    };
  }
});
...
const _hoisted_2$1 = { class: "tool-card-content" };
const _hoisted_3 = { class: "tool-card-header" };
const _hoisted_4 = { class: "tool-title" };
const _hoisted_5 = { class: "tool-desc" };
const _hoisted_6 = {
  key: 0,
  class: "tool-meta"
};
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("a", {
        ...
        createBaseVNode("div", {
          class: "tool-card-glow",
          style: normalizeStyle(glowStyle.value)
        }, null, 4),
        createBaseVNode("div", _hoisted_2$1, [
          createBaseVNode("div", _hoisted_3, [
            createVNode(SvgIcons, { name: displayIcon.value }, null, 8, ["name"]),
            createBaseVNode("h3", _hoisted_4, toDisplayString(__props.tool.title), 1)
          ]),
          createBaseVNode("p", _hoisted_5, toDisplayString(__props.tool.description), 1),
          __props.tool.tags && __props.tool.tags.length ? (openBlock(), createElementBlock("div", _hoisted_6, [
            (openBlock(true), createElementBlock(Fragment, null, renderList(__props.tool.tags, (tag) => {
              return openBlock(), createElementBlock("span", {
                key: tag,
                class: "tool-tag"
        ...
        _cache[0] || (_cache[0] = createStaticVNode('<span class="tool-external" data-v-13aa5d77><svg class="external-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" data-v-13aa5d77><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6" data-v-13aa5d77></path><polyline points="15 3 21 3 21 9" data-v-13aa5d77></polyline><line x1="10" y1="14" x2="21" y2="3" data-v-13aa5d77></line></svg></span>', 1))
      ], 40, _hoisted_1$2);
    };
  }
});
...
function _sfc_render(_ctx, _cache) {
  return openBlock(), createElementBlock("div", _hoisted_1$1, [..._cache[0] || (_cache[0] = [
    createStaticVNode('<div class="skeleton-header" data-v-163d5295><div class="skeleton-icon" data-v-163d5295></div><div class="skeleton-title" data-v-163d5295></div></div><div class="skeleton-desc" data-v-163d5295></div><div class="skeleton-meta" data-v-163d5295><div class="skeleton-tag" data-v-163d5295></div><div class="skeleton-tag" data-v-163d5295></div></div>', 3)
  ])]);
}
const SkeletonCard = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["render", _sfc_render], ["__scopeId", "data-v-163d5295"]]);
const _hoisted_1 = { class: "tool-grid-container" };
const _hoisted_2 = {
  key: 0,
  class: "nav-category-title"
};
const _sfc_main = /* @__PURE__ */ defineComponent({
  __name: "ToolGrid",
  props: {
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1, [
        __props.title ? (openBlock(), createElementBlock("h2", _hoisted_2, [
          __props.icon ? (openBlock(), createBlock(SvgIcons, {
            key: 0,
            name: __props.icon,
        ...
        createBaseVNode("div", {
          class: normalizeClass(["tool-grid", { "is-loading": __props.loading }])
        }, [
          __props.loading ? (openBlock(true), createElementBlock(Fragment, { key: 0 }, renderList(skeletonCount.value, (i) => {
            return openBlock(), createBlock(SkeletonCard, {
              key: `skeleton-${i}`
            });
          }), 128)) : (openBlock(true), createElementBlock(Fragment, { key: 1 }, renderList(__props.tools, (tool) => {
