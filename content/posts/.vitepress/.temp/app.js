...
const siteData = deserializeFunctions(JSON.parse('{"lang":"zh-CN","dir":"ltr","title":"MyBlog","description":"个人博客与网址导航","base":"/","head":[],"router":{"prefetchLinks":true},"appearance":true,"themeConfig":{"logo":"/logo.svg","siteTitle":"MyBlog","nav":[{"text":"首页","link":"/"},{"text":"博客","link":"/blog/"},{"text":"导航","link":"/navigation/"},{"text":"关于","link":"/about/"}],"sidebar":{"/blog/":[{"text":"博客文章","items":[{"text":"所有文章","link":"/blog/"}]}],"/navigation/":[{"text":"网址导航","items":[{"text":"全部导航","link":"/navigation/"}]}]},"socialLinks":[{"icon":"github","link":"https://github.com"}],"footer":{"message":"基于 VitePress 构建","copyright":"Copyright © 2024-present"},"search":{"provider":"local"},"outline":{"level":[2,3]},"docFooter":{"prev":"上一页","next":"下一页"},"lastUpdated":{"text":"最后更新于","formatOptions":{"dateStyle":"short","timeStyle":"short"}}},"locales":{},"scrollOffset":134,"cleanUrls":false}'));
...
const _sfc_main$w = /* @__PURE__ */ defineComponent({
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const VPLocalSearchBox = defineAsyncComponent(() => import("./VPLocalSearchBox.DKoCYVlG.js"));
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "svg-icon" }, _attrs))} data-v-f1dff19b>`);
      if (__props.name === "blog") {
        _push(`<svg class="icon-blog" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" data-v-f1dff19b><rect x="3" y="4" width="18" height="18" rx="2" ry="2" data-v-f1dff19b></rect><line x1="16" y1="2" x2="16" y2="6" data-v-f1dff19b></line><line x1="8" y1="2" x2="8" y2="6" data-v-f1dff19b></line><line x1="3" y1="10" x2="21" y2="10" data-v-f1dff19b></line><path d="M8 14h.01" data-v-f1dff19b></path><path d="M12 14h.01" data-v-f1dff19b></path><path d="M16 14h.01" data-v-f1dff19b></path><path d="M8 18h.01" data-v-f1dff19b></path><path d="M12 18h.01" data-v-f1dff19b></path><path d="M16 18h.01" data-v-f1dff19b></path><path d="M19 9l-5 5-4-4-3 3" data-v-f1dff19b></path></svg>`);
      } else if (__props.name === "link") {
        _push(`<svg class="icon-link" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" data-v-f1dff19b><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71" data-v-f1dff19b></path><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71" data-v-f1dff19b></path></svg>`);
      } else if (__props.name === "idea") {
        _push(`<svg class="icon-idea" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" data-v-f1dff19b><path d="M12 2a6 6 0 0 0-6 6c0 7 6 12 6 12s6-5 6-12a6 6 0 0 0-6-6z" data-v-f1dff19b></path><circle cx="12" cy="10" r="3" data-v-f1dff19b></circle></svg>`);
      } else if (__props.name === "glass") {
        _push(`<svg class="icon-glass" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" data-v-f1dff19b><path d="M2 3h20" data-v-f1dff19b></path><path d="M5 3v18c0 1.1.9 2 2 2h10c1.1 0 2-.9 2-2V3" data-v-f1dff19b></path><path d="M12 18v4" data-v-f1dff19b></path><path d="M9 22h6" data-v-f1dff19b></path></svg>`);
      } else if (__props.name === "search") {
        _push(`<svg class="icon-search" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" data-v-f1dff19b><circle cx="11" cy="11" r="8" data-v-f1dff19b></circle><line x1="21" y1="21" x2="16.65" y2="16.65" data-v-f1dff19b></line></svg>`);
      } else if (__props.name === "responsive") {
        _push(`<svg class="icon-responsive" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" data-v-f1dff19b><rect x="2" y="3" width="20" height="14" rx="2" ry="2" data-v-f1dff19b></rect><line x1="8" y1="21" x2="16" y2="21" data-v-f1dff19b></line><line x1="12" y1="17" x2="12" y2="21" data-v-f1dff19b></line></svg>`);
      } else {
        _push(`<span data-v-f1dff19b>${ssrInterpolate(__props.name)}</span>`);
      }
      _push(`</div>`);
    };
  }
...
_sfc_main$3.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add(".vitepress/theme/components/SvgIcons.vue");
  return _sfc_setup$3 ? _sfc_setup$3(props, ctx) : void 0;
};
const SvgIcons = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-f1dff19b"]]);
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<a${ssrRenderAttrs(mergeProps({
        href: __props.tool.url,
        target: "_blank",
        rel: "noopener noreferrer",
        class: "tool-card"
      }, _attrs))} data-v-13aa5d77><div class="tool-card-glow" style="${ssrRenderStyle(glowStyle.value)}" data-v-13aa5d77></div><div class="tool-card-content" data-v-13aa5d77><div class="tool-card-header" data-v-13aa5d77>`);
      _push(ssrRenderComponent(SvgIcons, { name: displayIcon.value }, null, _parent));
      _push(`<h3 class="tool-title" data-v-13aa5d77>${ssrInterpolate(__props.tool.title)}</h3></div><p class="tool-desc" data-v-13aa5d77>${ssrInterpolate(__props.tool.description)}</p>`);
      if (__props.tool.tags && __props.tool.tags.length) {
        _push(`<div class="tool-meta" data-v-13aa5d77><!--[-->`);
        ssrRenderList(__props.tool.tags, (tag) => {
          _push(`<span class="tool-tag" data-v-13aa5d77>${ssrInterpolate(tag)}</span>`);
        });
        _push(`<!--]--></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div><span class="tool-external" data-v-13aa5d77><svg class="external-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" data-v-13aa5d77><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6" data-v-13aa5d77></path><polyline points="15 3 21 3 21 9" data-v-13aa5d77></polyline><line x1="10" y1="14" x2="21" y2="3" data-v-13aa5d77></line></svg></span></a>`);
    };
  }
});
...
_sfc_main$2.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add(".vitepress/theme/components/ToolCard.vue");
  return _sfc_setup$2 ? _sfc_setup$2(props, ctx) : void 0;
};
const ToolCard = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-13aa5d77"]]);
const _sfc_main$1 = {};
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  _push(`<div${ssrRenderAttrs(mergeProps({
    class: "skeleton-card",
    "aria-hidden": true
  }, _attrs))} data-v-163d5295><div class="skeleton-header" data-v-163d5295><div class="skeleton-icon" data-v-163d5295></div><div class="skeleton-title" data-v-163d5295></div></div><div class="skeleton-desc" data-v-163d5295></div><div class="skeleton-meta" data-v-163d5295><div class="skeleton-tag" data-v-163d5295></div><div class="skeleton-tag" data-v-163d5295></div></div></div>`);
}
const _sfc_setup$1 = _sfc_main$1.setup;
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add(".vitepress/theme/components/SkeletonCard.vue");
  return _sfc_setup$1 ? _sfc_setup$1(props, ctx) : void 0;
};
const SkeletonCard = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-163d5295"]]);
const _sfc_main = /* @__PURE__ */ defineComponent({
  __name: "ToolGrid",
  __ssrInlineRender: true,
  props: {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "tool-grid-container" }, _attrs))} data-v-d9491cb1>`);
      if (__props.title) {
        _push(`<h2 class="nav-category-title" data-v-d9491cb1>`);
        if (__props.icon) {
          _push(ssrRenderComponent(SvgIcons, {
            name: __props.icon,
        ...
        _push(`<span data-v-d9491cb1>${ssrInterpolate(__props.title)}</span></h2>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="${ssrRenderClass([{ "is-loading": __props.loading }, "tool-grid"])}" data-v-d9491cb1>`);
      if (__props.loading) {
        _push(`<!--[-->`);
        ssrRenderList(skeletonCount.value, (i) => {
          _push(ssrRenderComponent(SkeletonCard, {
            key: `skeleton-${i}`
          }, null, _parent));
        });
        _push(`<!--]-->`);
        ...
        ssrRenderList(__props.tools, (tool) => {
          _push(ssrRenderComponent(ToolCard, {
            key: tool.url,
            tool
          }, null, _parent));
        });
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add(".vitepress/theme/components/ToolGrid.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const ToolGrid = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-d9491cb1"]]);
const DEFAULT_GLOW_SELECTOR = ".mouse-glow, .VPFeature";
function initMouseGlow(options = {}) {
  ...
  elements.forEach((element) => {
    ...
    listeners2.push({ element, move, leave });
  });
  return () => {
    listeners2.forEach(({ element, move, leave }) => {
      element.removeEventListener("mousemove", move);
      element.removeEventListener("mouseleave", leave);
    });
  };
}
const DEFAULT_SCROLL_SELECTOR = ".scroll-animate, .scroll-animate-left, .scroll-animate-right, .scroll-animate-scale, .scroll-animate-fade";
...
const RawTheme = {
  ...
  setup() {
    let stopScrollAnimation = null;
    let stopMouseGlow = null;
    onMounted(() => {
      nextTick(() => {
    ...
    onUnmounted(() => {
      stopScrollAnimation == null ? void 0 : stopScrollAnimation();
      stopMouseGlow == null ? void 0 : stopMouseGlow();
