...
const _sfc_main = /* @__PURE__ */ Object.assign(__default__, {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)}><h1 id="网址导航" tabindex="-1">网址导航 <a class="header-anchor" href="#网址导航" aria-label="Permalink to &quot;网址导航&quot;">​</a></h1><div class="page-intro"><p>收藏优质网站与工具，按分类组织，便于快速查找与访问。</p></div><div class="gradient-divider"></div><!--[-->`);
      ssrRenderList(unref(tools), (category) => {
        _push(ssrRenderComponent(_component_ToolGrid, {
          key: category.slug,
          title: category.name,
          icon: category.icon,
